...
document.body.addEventListener('touchmove', function (event) {
  ...
  if (target instanceof Node) check: do {
    for (let ref = target; ref; ref = ref.parentNode) {
...
; (async function () {
  ...
  rootStyle('light_background', 'rgb(60,63,68)', '--light-background');
  rootStyle('dark_background', 'rgb(60,63,68)', '--dark-background');
}());
